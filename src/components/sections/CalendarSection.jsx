        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle className="flex items-center gap-2">
              <>
                <Calendar className="w-5 h-5 text-green-600 dark:text-green-400" style={{ display: 'inline-block' }} />
                <CalendarIcon />
              </>
              Weekly Menu
            </CardTitle>
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <>
                  <ChevronLeft size={16} style={{ display: 'inline-block' }} />
                  <ChevronLeftIcon />
                </>
              </Button>
              ...
              >
                <>
                  <ChevronRight size={16} style={{ display: 'inline-block' }} />
                  <ChevronRightIcon />
                </>
              </Button>
            </div>
